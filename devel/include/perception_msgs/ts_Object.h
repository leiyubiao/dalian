...
bool operator==(const ::perception_msgs::ts_Object_<ContainerAllocator1> & lhs, const ::perception_msgs::ts_Object_<ContainerAllocator2> & rhs)
{
  return lhs.object_id == rhs.object_id &&
    lhs.rel_pose == rhs.rel_pose &&
    lhs.geometry_state == rhs.geometry_state &&
