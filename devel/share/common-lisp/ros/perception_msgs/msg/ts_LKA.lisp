...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ts_LKA>)))
  ...
  (cl:format cl:nil "Header header~%int64 lanetype  #0-dashed 1-solid 2-undecided 3-road edge 4-double lane mark 5-Botts' dots 6-invalid~%int64 quality   #0,1-low quality 2,3-high quality~%int64 model     # 1-linear, 2-parabolic, 3-3rd degree model~%float64 View_range~%float64 Position_C0~%float64 Headingangle_C1~%float64 Curvature_C2~%float64 dCurvature_C3~%float64 Lane_width~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ts_LKA)))
  "Returns full string definition for message of type 'ts_LKA"
  (cl:format cl:nil "Header header~%int64 lanetype  #0-dashed 1-solid 2-undecided 3-road edge 4-double lane mark 5-Botts' dots 6-invalid~%int64 quality   #0,1-low quality 2,3-high quality~%int64 model     # 1-linear, 2-parabolic, 3-3rd degree model~%float64 View_range~%float64 Position_C0~%float64 Headingangle_C1~%float64 Curvature_C2~%float64 dCurvature_C3~%float64 Lane_width~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
